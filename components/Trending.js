    ...
    <div className="hidden lg:flex flex-col ml-7 mt-4">
      ...
      <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="p-3 relative">
          ...
          <h1 className="text-[15px] font-bold">Frontend Developer</h1>
          <p className="text-xs text-gray-500">800K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">full-stack engineer</h1>
          <p className="text-xs text-gray-500">500K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">Google</h1>
          <p className="text-xs text-gray-500">900K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">Covid</h1>
          <p className="text-xs text-gray-500">234K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">Lucian Bellevue</h1>
          <p className="text-xs text-gray-500">1.8M Tweets</p>
        </div>
      </div>
          ...
          <div className="flex space-x-3">
            ...
            <div>
              <div className="flex space-x-1">
                <h1 className="font-bold">Lucian Bellevue</h1>
                <BadgeCheckIcon className="w-[18px] text-blue-400" />
              </div>
              <h1 className="text-[12px] mt-1 text-gray-500">@lucianbellevue</h1>
            </div>
          </div>
